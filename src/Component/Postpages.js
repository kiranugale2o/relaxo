...
<div className="card shadow-sm p-3 mb-5 bg-body-white rounded" style={{ width: "100%" }}>
  <div className="card-body" style={{width:"100%"}} >
  <div className="card-nav" style={{display:"flex"}}>
        <img src="avtar.jpg"  className="rounded-5"  style={{width:"14%" ,height:"60px",borderRadius:"50%" ,borderStyle:"solid" ,borderColor:"black"}} ></img>
   <div className="card-info" style={{display:"block",margin:"auto"}}>
    ...
    <button type="button " className="btn btn-primary" style={{ display:`${show}` , width:"20%" ,position:"absolute",top:"16%", left:"70%"}}>Follow</button>
    </div>
  ...
  <path d="M9.5 13a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0zm0-5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0zm0-5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0z"/>
    ...
    <div className="card">
    <img src={props.imageUrl}style={{height:`${props.height+"px"}`}} className="card-img-top" alt="" />
      </div>
